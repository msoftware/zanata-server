...
public class ActivityServiceImplTest extends ZanataDbunitJpaTest {
    ...
    public void testNewReviewActivityInserted() throws Exception {
        activityService.logTextFlowStateUpdate(new TextFlowTargetStateEvent(
                versionId, documentId, null, new LocaleId("as"),
    ...
    public void testGetAllPersonActivities() throws Exception {
        ...
        activityService.logTextFlowStateUpdate(new TextFlowTargetStateEvent(
                versionId, documentId2, null, LocaleId.EN_US, new Long(5),
                ContentState.Translated, ContentState.NeedReview));
        ...
        activityService.logTextFlowStateUpdate(new TextFlowTargetStateEvent(
                versionId, documentId2, null, LocaleId.EN_US, new Long(6),
                ContentState.Rejected, ContentState.NeedReview));

        activityService.logTextFlowStateUpdate(new TextFlowTargetStateEvent(
                versionId, documentId2, null, LocaleId.EN_US, new Long(6),
                ContentState.NeedReview, ContentState.NeedReview));
